...
if page == "SQL QUERYS":
    ...
    options = ['Query1','Query2','Query3','Query4','Query5','Query6','Query7','Query8','Query9','Query10','Query11','Query12','Query13','Query14','Query15']
    # Creating a select box in the sidebar for the user to choose a query
    col = st.sidebar.selectbox("Select any query :",options)
    ...
    if col == "Query2":
        ...
        ax.set_title("Pie Chart for Diagnosis") 
        st.pyplot(fig)
